      ...
      <div class="container">
         <div class="row">
            <div class="col-md-2 col-sm-2">
               <div class="logo"><a href="../index.php"><img src="../public/frontend/images/logo.png" alt="FlatShop"></a></div>
            </div>
                     ...
                     <div class="col-md-3">
                        ...
                        ?>
                              ...
                              <ul class="dropdown-menu">
                                 ...
                                 <li><a class="dropdown-item" href="lichsu-thanhtoan.php">Đơn hàng của bạn</a></li>
                  ...
                  <?php 
                     if (isset($_SESSION['email_user'])){
                      ...
                      ?>
                        ...
                        <a href="cart.php" class="cart-icon">cart <span class="cart_no"><?php echo $count_cart ?></span></a>
                     <?php
                     }
                  ?>
               ...
               <div class="navbar-collapse collapse">
                  <ul class="nav navbar-nav">
                     ...
                     <?php 
                        ...
                        ?>
                        <li><a href="products.php?idCategory=<?php echo $key ?>"><?php echo $row['Category-name']?></a></li>
                        <?php
                        }
                     }
                     ?>
